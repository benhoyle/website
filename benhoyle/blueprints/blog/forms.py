...
from wtforms import (
    StringField, TextAreaField, SubmitField, TextField,
    PasswordField, BooleanField, SelectMultipleField, SelectField
    )
...
class PostForm(Form):
    ...
    content = TextAreaField(
        label="Post Text",
        description="Type post content here",
        validators=[DataRequired()]
        )
...
class LoginForm(Form):
    ...
    login = TextField(
        'User login',
        [Required(message='Forgot your login name?')]
        )
